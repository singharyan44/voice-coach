...
for (const id of ['connectBtn', 'startAttemptBtn', 'finishAttemptBtn', 'retryBtn', 'newPromptBtn', 'sampleABtn', 'sampleBBtn', 'practiceAssignedBtn', 'debateStartBtn', 'roundStartBtn', 'roundFinishBtn', 'diagnoseBtn', 'rematchBtn', 'debateSampleForBtn', 'debateSampleAgainstBtn']) {  const re = new RegExp('<button[^>]*id="' + id + '"[^>]*>', 'i');
